  ...
  return (
    <>
      ...
      <div className={`h-full w-full  `}>
        ...
        <div className={`w-[38%] flex justify-end h-full bg-white absolute z-40 top-0 transition-all duration-300 ease-in-out ${toggaleSearch ? "left-0" : "-left-[38%]"}`}>
          <div className='w-[62%] mr-12'>
            <div className='py-5'>
              <div className='mb-7'>
      ...
      <div className='h-full'>
        ...
        <div className={`w-[38%] flex justify-start h-full bg-white fixed z-40 top-0 transition-all duration-300 ease-in-out ${toggaleLogIn ? ' right-0' : ' -right-[38%]'}`}>
         <SignInPage />
        </div>
      </div>
      ...
      <div className='relative'>
        <div className='w-full shadow-md h-20 flex justify-between items-center px-40'>
          <div className='flex gap-12 justify-center items-center'>
            <Link to={"/"} ><div className='rounded-xl hover:scale-[1.1] duration-100 w-12 h-12 overflow-hidden cursor-pointer'><img className='h-full w-full object-cover' src={assets.swiggyIcon} alt="" /></div></Link>
            <div
              onClick={toggleSearchCOntainer}
                  ...
                  items?.name === "Sign In" ?
                    ...
                    <div
                      ...
                      <li className='text-base font-[550] hover:cursor-pointer hover:text-orange-600 flex items-center justify-between gap-2'>
                        ...
                        {userData ? <span className='line-clamp-1 w-28'>{userData.name}</span> : <span>{items.name}</span>}
                      </li>
                    </div>

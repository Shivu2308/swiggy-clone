...
const RasturantCard = ( info ) => {
    ...
    return (
        ...
        <Link to={`/city/${city}/${link}`}>
            <div className='w-[274px] h-[182px] rounded-xl overflow-hidden relative'>
                <img
                    key={info.id}
                    ...
                    alt=""
                />
                <div className='absolute bg-gradient-to-t from-[rgba(0,0,0,1)] to-[rgba(0,0,0,0.1)] w-full h-[50%] bottom-0 text-[#ffffff] font-extrabold text-lg'><span className='absolute bottom-0 p-2 opacity-90'>
            ...
            <div className='p-3'>
                <div className='font-bold text-lg leading-none'>{info.name}</div>
